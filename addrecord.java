...
public class addrecord extends JFrame implements ActionListener
{
	...
	public addrecord()
	{
		...
		JPanel p=new JPanel();
		c.setLayout(null);
		lb=new JLabel("添加数据操作");
		lb.setSize(200,20);
		lb.setLocation(10,20);
		c.add(lb);
		bu1=new JButton("添加记录");
		bu1.setSize(100,20);
		...
		for(int i=0;i<7;i++)
		{
			...
			tf1[i].setSize(90,20);
			tf1[i].setLocation(120,120+i*30);
			c.add(tf1[i]);
		}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try
		{
	      if(e.getSource()==bu1)
	      {
			...
			str1="INSERT INTO "+pp+" VALUES('"+std_fanghao+"','"+std_xibie+"','"+std_zhuanye+"','"+std_grade+"','"+std_class+"','"+std_name+"','"+std_tel+"')";
